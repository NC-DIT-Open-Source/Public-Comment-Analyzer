...
NC DIT operates a reference instance at [[REDACTED]](https://[REDACTED]) for use by NC state employees — public access is restricted to North Carolina state government IP ranges. To run it yourself, deploy your own copy to your own AWS account using the steps below.
