...
NC DIT operates an instance at [[REDACTED]](https://[REDACTED]). External users should deploy their own copy to their own AWS account; the steps below walk through that.
...
- **NC DIT instance** (reference deployment): https://[REDACTED]
